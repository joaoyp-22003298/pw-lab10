...
STATICFILES_DIRS = [str(BASE_DIR.joinpath('portfolio/static'))]  # novo se a pasta static estiver na pasta da
...
CLOUDINARY_STORAGE = {
  'CLOUD_NAME': "duarmm0cj",
  'API_KEY': "199878832529665",
  'API_SECRET': "1GfsGVGNR0MubVAUQsdqRGj-sB4",
}
